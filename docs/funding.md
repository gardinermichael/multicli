...
<div class="support-options" style="margin: 32px auto; max-width: 600px;">
  <a href="https://github.com/sponsors/osanoai" target="_blank" rel="noopener" class="support-button support-button--primary">
  ...
  <a href="https://github.com/sponsors/osanoai" target="_blank" rel="noopener" class="support-button support-button--secondary">
