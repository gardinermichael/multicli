...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Leave a Star ⭐
      link: https://github.com/osanoai/multicli
...
For installation and setup instructions, please refer to our [GitHub repository](https://github.com/osanoai/multicli#readme) which contains the most up-to-date installation guide.
