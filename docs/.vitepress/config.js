...
export default withMermaid(
  defineConfig({
    ...
    head: [
      ['link', { rel: 'icon', href: '/multicli/favicon.ico' }],
      ['link', { rel: 'icon', type: 'image/png', sizes: '128x128', href: '/multicli/icon.png' }],
      ['link', { rel: 'apple-touch-icon', sizes: '128x128', href: '/multicli/icon.png' }]
    ],
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/osanoai/multicli' }
    ],
