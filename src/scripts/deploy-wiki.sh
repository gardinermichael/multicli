...
rm -rf .wiki-temp
git clone https://github.com/osanoai/multicli.wiki.git .wiki-temp 2>/dev/null || {
    echo "⚠️  Wiki doesn't exist yet. Creating it through GitHub..."
    # Create initial wiki page through API
    gh api repos/osanoai/multicli/wiki/pages \
        --method POST \
        -f title="Home" \
        -f body="Initializing wiki..." || true
    
    # Try cloning again
    git clone https://github.com/osanoai/multicli.wiki.git .wiki-temp
}
...
**Quick Links**
* [📦 NPM Package](https://www.npmjs.com/package/multicli)
* [🐙 GitHub Repo](https://github.com/osanoai/multicli)
* [📋 Report Issue](https://github.com/osanoai/multicli/issues/new)
EOF

# Create footer
cat > _Footer.md << 'EOF'
---
🔧 [Contribute](https://github.com/osanoai/multicli/blob/main/CONTRIBUTING.md) |
📦 [NPM](https://www.npmjs.com/package/multicli) |
⭐ [Star on GitHub](https://github.com/osanoai/multicli)
EOF
...
echo "🔗 View at: https://github.com/osanoai/multicli/wiki"
echo ""
