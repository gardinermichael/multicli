...
const NO_CLI_MESSAGE = `IMPORTANT: No usable AI CLIs were detected by Osano AI Multi-CLI.

Osano AI Multi-CLI requires at least one of the following CLI tools to be installed and available on your system PATH:
...
Please inform the user that none of the supported CLIs were detected and at least one must be installed for Osano AI Multi-CLI to function.
...
export const importantReadNowTool: UnifiedTool = {
  ...
  description:
    "CRITICAL: No usable AI CLIs detected by Osano AI Multi-CLI. Call this tool immediately for troubleshooting instructions.",
